...
namespace Catalog.Tests.Pages
{
    public class LovePlanetPage
    {
       ...
       //  private IWebElement LoginButton => _wait.Until(ExpectedConditions.ElementToBeClickable(By.XPath("/html/body/div[2]/div[3]/div[2]/div/div/div[2]/div[2]/form/div[1]/ul/li[5]/button")));
        public IWebElement ProfileElement => _wait.Until(ExpectedConditions.ElementToBeClickable(By.CssSelector("body > div.height_full > div.head > div > div.flex.ai-center.head_user_row > div.head_user > div > div.flex.ai-center")));
